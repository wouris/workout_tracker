        ...
        <View style={{flex: 1, justifyContent: 'center'}}>
            <View style={{paddingHorizontal: 50}}>
                <View style={{alignItems: 'center'}}>
                    <ImageBackground source={require('../../assets/background/lift.png')}
                ...
                <View
                    ...
                    <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                        <TouchableOpacity
                            ...
                            <ImageBackground source={require('../../assets/badges/gogel.png')}
                ...
                <View
                    ...
                    <TouchableOpacity onPress={() => navigation.dispatch(StackActions.push('RegisterScreen'))}>
